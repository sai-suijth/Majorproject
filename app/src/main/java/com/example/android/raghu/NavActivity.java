...
public class NavActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_upload) {
           ...
           try {
                Intent intent = new Intent (Intent.ACTION_VIEW , Uri.parse("mailto:" + "saisujith222@gmail.com"));
           ...
           // Intent intent = new Intent(NavActivity.this,Chatbot.class);
            //startActivity(intent);
            Toast.makeText(getBaseContext(), "chat bot is getting ready !!", Toast.LENGTH_SHORT).show();
        }
           ...
           startActivity(intent);
            ...
            tweetIntent.putExtra(Intent.EXTRA_TEXT, "This is the pollutant @cvrcoenews. Hope you resolve asap");
